...
(@EWS_RETAIL_ID, 'BASE_POINT', N'Điểm cơ sở', '100', 'COEFFICIENT', 'NUMERIC', NULL, NULL, 1, '2024-03-01', '2024-03-01', '2026-03-01', 1),
(@EWS_RETAIL_ID, 'OUTSTANDING_CHANGE_WEIGHT', N'Trọng số thay đổi dư nợ', '25', 'COEFFICIENT', 'NUMERIC', NULL, NULL, 1, '2024-03-01', '2024-03-01', '2026-03-01', 1),
(@EWS_RETAIL_ID, 'INCOME_REDUCTION_WEIGHT', N'Trọng số giảm thu nhập', '30', 'COEFFICIENT', 'NUMERIC', NULL, NULL, 1, '2024-03-01', '2024-03-01', '2026-03-01', 1),
(@EWS_RETAIL_ID, 'LATE_PAYMENT_WEIGHT', N'Trọng số thanh toán trễ', '40', 'COEFFICIENT', 'NUMERIC', NULL, NULL, 1, '2024-03-01', '2024-03-01', '2026-03-01', 1),
(@EWS_RETAIL_ID, 'CREDIT_LIMIT_USAGE_WEIGHT', N'Trọng số sử dụng hạn mức tín dụng', '20', 'COEFFICIENT', 'NUMERIC', NULL, NULL, 1, '2024-03-01', '2024-03-01', '2026-03-01', 1),
(@EWS_RETAIL_ID, 'WARNING_THRESHOLD', N'Ngưỡng cảnh báo', '{"Green": 50, "Yellow": 75, "Orange": 100, "Red": 150}', 'THRESHOLD', 'JSON', NULL, NULL, 0, NULL, '2024-03-01', '2026-03-01', 1);
GO

PRINT 'Đã nhập dữ liệu mẫu cho bảng MODEL_PARAMETERS thành công.';
GO